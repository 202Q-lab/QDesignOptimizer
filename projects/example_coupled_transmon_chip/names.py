from qdesignoptimizer.utils.constants import COUPLER, QUBIT, RESONATOR
...
QUBIT_1 = mode(QUBIT, nbr=NBR_1)
RESONATOR_1 = mode(RESONATOR, nbr=NBR_1)
QUBIT_2 = mode(QUBIT, nbr=NBR_2)
RESONATOR_2 = mode(RESONATOR, nbr=NBR_2)
