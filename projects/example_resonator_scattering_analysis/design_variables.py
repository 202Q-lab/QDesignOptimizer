...
from qdesignoptimizer.utils.utils_design_variables import design_var_cj, design_var_lj
...
DESIGN_VARS = {
    **JUNCTION_VARS,
    ...
    design_var_res_coupl_length(0): "577.0052335141787 um",
    design_var_res_coupl_length(1): "200um",
    design_var_res_coupl_length(2): "597.7427251031493 um",
