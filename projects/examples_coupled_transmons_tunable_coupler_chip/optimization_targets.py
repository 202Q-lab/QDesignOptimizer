...
def get_opt_target_coupler_qubit_chi(qubit):
    return OptTarget(
        ...
        control_var=n.design_var_coupl_length(n.COUPLER_12, qubit),
        control_var_constraint={"larger_than": "1um", "smaller_than": "80um"},
    ...
    for group in groups:
        ...
        opt_targets.extend(
            get_opt_targets_qb_res_transmission(
                ...
                control_var_constraint_qubit_width={
                    "larger_than": "1um",
                    "smaller_than": "900um",
                },
                control_var_constraint_res_coupl_length={
                    "larger_than": "1um",
                    "smaller_than": "1500um",
                },
                control_var_constraint_res_qb_coupl_length={
                    "larger_than": "1um",
                    "smaller_than": "80um",
                },
            )
