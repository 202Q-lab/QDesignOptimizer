...
def calculate_t1_limit_grounded_lumped_mode_decay_into_chargeline(
    ...
    gamma = decay_rate_oscillator_transmissionline(mode_freq_GHz, mode_capacitance_fF, mode_capacitance_to_charge_line_fF, charge_line_impedance)
...
def calculate_t1_limit_floating_lumped_mode_decay_into_chargeline(
    ...
    coupling_capacitance = np.abs((cap_a * cap_island_b_line_fF - cap_b * cap_island_a_line_fF) / (cap_a + cap_b))
    
    gamma = decay_rate_oscillator_transmissionline(mode_freq_GHz, Csum, coupling_capacitance, charge_line_impedance)
