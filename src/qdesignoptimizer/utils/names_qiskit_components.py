...
def name_mode_to_mode(identifier_1: Mode, identifier_2: Mode) -> QiskitComponentName:
    ...
    return f"name_{identifier_1}_to_{identifier_2}_"
...
def name_flux_line(identifier: Union[str, int]) -> QiskitComponentName:
    ...
    return f"name_flux_line_{identifier}_"
...
def name_lp_to_tee(
    ...
    return f"name_lp{lp_identifier}_to_tee{tee_identifier}_"
...
def name_tee_to_tee(
    ...
    return f"name_tee{tee_identifier1}_to_tee{tee_identifier2}_"
...
def name_lp_to_chargeline(
    ...
    return f"name_lp{lp_identifier}_to_chargeline{chargeline_identifier}_"
