...
def get_mini_study_2qb_coupler():
    all_comps = []
    all_ports = []
    all_modes = []
    all_jjs = {}
    ...
    return MiniStudy(
        ...
        modes=all_modes_sorted,
        jj_setup=all_jjs,
        design_name="get_mini_study_2qb_coupler",
        adjustment_rate=1,
        cos_trunc=6,
        fock_trunc=5,
        build_fine_mesh=False,
...
def get_mini_study_2qb_resonator_coupler_partitioned(
    section: Literal["res_qb_cplr", "qb_cplr_qb", "cplr_qb_res"],
):
    all_comps = []
    all_ports = []
    all_modes = []
